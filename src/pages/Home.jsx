		...
		<>
			...
			<section className='common__section'>
                <Container>
                    <Row>
                        <Col lg={12}>
                            <h1><strong>Shop for your ideal chess set</strong><br/>
							<span className="small-text"> and make great memories.</span></h1>
							<button className="shop-button" onClick={()=>navigate("/tours")}>SHOP CHESS SETS</button>
                        </Col>
                    </Row>
						...
						<Col lg={12}>
							<div className="gallery__content">
								...
								<h2 className="gallery__title">
									Find The Perfect Chess Set <br />And Make Great Memories
								</h2>
							</div>
						</Col>
			...
			{/* ==================== Phần mới ======================= */}
			<section className="section section-blends section-full" ref={ref} onChange={onInViewChange} style={{ backgroundColor: "white" }}>
                <Container>
                    <Row>
                        <Col lg={12}>
                            <div className="impact-text impact-text--center">
                                <div className="snap-center">
                                    <h2 className="impact-text__text heading break-all">
                                        <span className="text-gradient" style={{ "--gradient": "linear-gradient(180deg, rgba(32, 138, 193, 1), rgba(26, 26, 26, 0) 100%)", 
											display: "block",
											position: "relative",
											textAlign: "center",
											overflow: "hidden", 
										}}>
                                            {inView && <CountUp end={21522} style={{fontSize:"12rem"}}/>}
                                        </span>
                                    </h2>
                                    <div className="impact-text__content">
                                        <div className="prose">
                                            <h3 className="h4 text-black text-30"><strong>PEOPLE RATE CHESS HOUSE ★★★★★</strong></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
				...
				<Container className="containerTest bg-gray-300">
					<Row>
						<Col lg={12}>
							...
							<h2 className="testimonial__title ml-14 mt-5"><strong>WHAT PEOPLE SAY</strong></h2>
						</Col>
						<Col lg={12}>
							<Testimonials />
						</Col>
